...
// ========================================================================
    ...
    void test_variadic_seminar() {
        ...
        std::unique_ptr<Unknown> up2 = my_make_unique<Unknown>(21, 22, 23);
    }



    // ====================================================================
    // 1. Beispiel fr ein variadisches Template:
...
void main_variadic_templates_introduction()
{
    ...
    VariadicTemplatesIntro_01::test_variadic_seminar();
    return;
