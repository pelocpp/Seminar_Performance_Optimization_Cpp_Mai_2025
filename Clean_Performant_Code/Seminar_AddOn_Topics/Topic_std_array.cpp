...
namespace StdArray {
    ...
    static void test_01() {
        ...
        std::array<short, 5> array6 = { 1, 2, 3, 4, 5 };
    }
    ...
    static void test_04() {
        ...
        std::array<int, 7> array2 = { 1, 2, 3, 4, 5, 6, 7  };
        print(array2);
...
#pragma warning(disable : 5056)
        ...
        // Worse: operator== compiles, but does the "wrong" thing:
        // address comparison!
...
#pragma warning(pop)
    ...
    // array decay:  decay: verkümmern // die Länge geht verloren
    ...
    static void test_31() {
        ...
        int carr[]{ 1, 2, 3, 4, 5 };
        printArray(std::span{ carr });   // So ist der span IMMER valid:
    ...
    static void test_99() {
        ...
        std::span mySpan{ vec };     // Idee: Bad  // smells
