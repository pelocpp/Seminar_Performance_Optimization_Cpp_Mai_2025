...
namespace Lambdas {
    ...
    static bool compare(int n1, int n2) {
        std::cout << "compare " << n1 << " mit " << n2 << std::endl;
        return n1 > n2;
    }
    ...
    public:
        ...
        bool operator() (int n1, int n2) const {
            std::cout << "Comparer::operator() " << n1 << " mit " << n2 << std::endl;
    ...
    static void test_07() {
        ...
        auto lambda1 = []() {
            static auto variable = 10;
            variable++;
            return variable;
        };

        auto lambda2 = [ variable = 10 ] () mutable -> int {
