...
namespace Algorithms {
    ...
    std::array<double, Size> values;   // implizites reserve
    ...
    static auto test_constant_initialize_classic_for_loop_versus_default_initialization()
    {
        std::println("A Comparison");
...

        {
            ...
            for (size_t i{}; i != 10000; ++i) {
                values[i] = 0;   // operator[] geht nur für einige Container
            }
        }
    ...
    static auto test_constant_initialize_std_for_each()
    {
        ...
        // Eigentlich ist std::for_each zum (lesenden) Traversieren gedacht.
        // Schreibenden: double&  == REFERENZ
...
void main_algorithms_array_perf()
{
    using namespace Algorithms;
    //test_constant_initialize_classic_for_loop_versus_default_initialization();
